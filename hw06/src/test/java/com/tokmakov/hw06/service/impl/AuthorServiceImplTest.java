...
public class AuthorServiceImplTest {
    ...
    void testFindFirst() {
        ...
        when(authorRepository.getByFirstAndLastNames(expectedAuthor.getFirstName(), expectedAuthor.getLastName()))
    ...
    void testAdd() {
        ...
        when(authorRepository.insert(newAuthor)).thenReturn(newAuthor);

        newAuthor = authorService.add(newAuthor);

        when(authorRepository.getByFirstAndLastNames(newAuthor.getFirstName(), newAuthor.getLastName()))
